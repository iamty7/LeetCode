...
public class LongestUncommonSubsequenceI {
	 ...
	 * 
	 * Example 1: Input: "aba", "cdc" Output: 3 Explanation: The longest
	 * uncommon subsequence is "aba" (or "cdc"), because "aba" is a subsequence
	 * of "aba", but not a subsequence of any other strings in the group of two
	 * strings. Note:
	 * 
	...
	public int findLUSlength(String a, String b) {
		// Your runtime beats 79.50% of java submissions. Runtime 3ms
